Download URL: https://sourceforge.net/projects/globe/files/Globe/globe-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 GLB fee schedule (users still pay 0.01 GLB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #globe00 - #globe99

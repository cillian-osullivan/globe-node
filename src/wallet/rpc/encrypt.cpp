...
RPCHelpMan walletpassphrase()
{
    return RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending globe\n"
            "\nNote:\n"
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    LOCK(pwallet->m_unlock_mutex);
    {
        ...
        if (pwallet->IsGlobeWallet()) {
            CHDWallet *phdw = GetGlobeWallet(pwallet);
...
RPCHelpMan encryptwallet()
{
    return RPCHelpMan{"encryptwallet",
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending globe\n"

 ...
 */
#ifndef GLOBE_UTIL_SYSTEM_H
#define GLOBE_UTIL_SYSTEM_H
...
extern const char * const GLOBE_CONF_FILENAME;
extern const char * const GLOBE_SETTINGS_FILENAME;

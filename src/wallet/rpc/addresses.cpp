...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                "\nReturns a new Globe address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new globe address"
                },
                RPCExamples{
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new Globe address, for receiving change.\n"
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "The globe address to be associated with a label."},
    ...
    return RPCHelpMan{"createmultisig",
                ...
                "It returns a json object with the address and redeemScript.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of keys which are qtum addresses or hex-encoded public keys.",
                        {
                            {"key", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, "globe address or hex-encoded public key"},
                        }},
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"GjWnDZxwLhrJDcp4Hisse8RfBo2jRDZY5Z\\\",\\\"G6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("createmultisig", "2, [\"GjWnDZxwLhrJDcp4Hisse8RfBo2jRDZY5Z\",\"G6sSauSf5pF2UkUwvKGq4qjNRzBZYqgEL5\"]")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{

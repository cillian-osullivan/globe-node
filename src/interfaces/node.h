...
#ifndef GLOBE_INTERFACES_NODE_H
#define GLOBE_INTERFACES_NODE_H
...
//! Top-level interface for a globe node (globed process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or globe.conf.

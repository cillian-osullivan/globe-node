...
# The block reward of coinbaseoutput.nValue (50) GLB/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 GLB/block.
...
class TestGlobeCli(GlobeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `globe-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and globe-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and globe-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 GLB) to the default wallet.
            ...
            # Test globe-cli -generate with -rpcwallet in multiwallet mode.

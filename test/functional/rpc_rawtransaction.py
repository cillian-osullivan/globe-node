...
class RawTransactionsTest(GlobeTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Globe address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 GLB/kvB
        ...
        # Fee rate is 0.20000000 GLB/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/globe/globe/issues/20579)
    ...
    def transaction_version_number_tests(self):
        ...
        """
        # Removed as collides with globe version

...
class TxnMallTest(GlobeTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 GLB:
        ...
        # First: use raw transaction API to send 1240 GLB to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GLB coin each
        ...
        # Node0's balance should be starting balance, plus 50GLB for another
        ...
        # Node0's total balance should be starting balance, plus 100GLB for

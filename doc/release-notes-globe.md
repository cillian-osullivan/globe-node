...
- rpc changes:
  ...
  - verifymessage
    ...
    devicesignmessage
    - Switched default message magic string to 'Globe Signed Message:\\n'
    - Sign functions accept a message magic parameter.
      Note: The ledger firmware will still use the Globe message magic string.
...
- wallet, qt: Default ring size set to 12 to match Globe Desktop.
- wallet: Fix GLB segwit address path and label in getaddressinfo.
...
- debugwallet inputs moved to a json object, new options:
  ...
  - trace_frozen_outputs: Dumps amounts, blinding values and optionally spent anon keys to aid in validating frozen outputs.
    - See: https://github.com/tecnovert/globe_debug_scripts/blob/main/trace_frozen.py
...
- Merged Globe 0.19.1 backports.
- Added generatemnemonic command to globe-wallet.
...
- Enabled segwit addresses in Globe mode for easier integrations.

...
#ifndef GLOBE_WALLET_TRANSACTION_H
#define GLOBE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this globe node, and set to 0 for transactions that were created
...
#endif // GLOBE_WALLET_TRANSACTION_H

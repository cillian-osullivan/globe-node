#ifndef GLOBEDELEGATION_H
#define GLOBEDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
#include <uint256.h>
#include <globe/posutils.h>
...
/**
 * @brief The IGlobeStaker class Delegation filter
 */
...
/**
 * @brief The GlobeDelegation class Communicate with the globe delegation contract
 */
class GlobeDelegation {
    
public:
    /**
     * @brief GlobeDelegation Constructor
     */
    GlobeDelegation();

    /**
     * @brief ~GlobeDelegation Destructor
     */
    virtual ~GlobeDelegation();
...
private:
    GlobeDelegation(const GlobeDelegation&);
    GlobeDelegation& operator=(const GlobeDelegation&);
    GlobeDelegationPriv* priv;
};
#endif

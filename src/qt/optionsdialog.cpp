    ...
    mapper(nullptr)
{
    ...
    ui->globeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->globeAtStartup);
    ...
    ui->globeAtStartup->setToolTip(ui->globeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->globeAtStartup->setText(ui->globeAtStartup->text().arg(PACKAGE_NAME));

    ui->openGlobeConfButton->setToolTip(ui->openGlobeConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GlobeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->globeAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSGLBontrols);
...
void OptionsDialog::on_openGlobeConfButton_clicked()
{

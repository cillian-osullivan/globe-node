...
#ifndef GLOBE_UTIL_MESSAGE_H
#define GLOBE_UTIL_MESSAGE_H
...
extern const std::string GLB_MESSAGE_MAGIC;
 ...
 * @param[in] address Signer's globe address, it must refer to a public key.
